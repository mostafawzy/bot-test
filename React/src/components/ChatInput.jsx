    ...
    <div className="flex items-center gap-3 max-w-4xl mx-auto mb-6 
      ...
      <textarea
        ...
        className="flex-1 resize-none rounded-2xl border border-[#C4DADE]/60 px-5 py-4 
                   ...
                   transition placeholder:text-gray-400 bg-white/80 text-base
      ...
      <button
        onClick={handleSend}
        className="p-4 rounded-full bg-[#C4DADE] hover:bg-[#b3cfd4] 
                   text-[#1F3634] shadow-md hover:shadow-lg transition-all duration-300"
        aria-label="send"
      >
        <FiArrowUp size={20} />
      </button>
